...
# print(range(N_non, N_non + p * N_sub, N_sub))  # [400, 480, ..., 800]


area = 20000*umetre**2
g_na = 1*msiemens*cm**-2 * area
ENa = 50*mV
VT = -63*mV
# modeling
eqs_E = '''
dv / dt = (- g_m_E * (v - V_L)- g_na*(m*m*m)*h*(v-ENa) - I_syn) / C_m_E : volt (unless refractory)
...
sp_E_sels_all = [SpikeMonitor(P_E[pi:pi + N_activity_plot]) for pi in range(N_non, N_non + p * N_sub, N_sub)]
